...
export type ModifyF = {
  ...
  >(
    path: Path & string,
    ...args: [...indicies: IndiciesForPath<Path>, modFunc: (v: Val) => Kind3<F, R, E, Val>]
  ...
  >(
    path: Path & string,
    ...args: [...indicies: IndiciesForPath<Path>, modFunc: (v: Val) => Kind2<F, E, Val>]
  ...
  >(
    path: Path & string,
    ...args: [...indicies: IndiciesForPath<Path>, modFunc: (v: Val) => Kind<F, Val>]
  ...
  >(
    path: Path & string,
    ...args: [...indicies: IndiciesForPath<Path>, modFunc: (v: Val) => HKT<F, Val>]
  ) => (a: Infer) => HKT<F, Infer>;
};
